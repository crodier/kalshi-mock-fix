...
public class FIFOPriorityTest {
    ...
    public void testFIFOExecutionOrder() {
        ...
        OrderBookEntry order1 = new OrderBookEntry("ORDER-1", "USER-1", Side.yes, "buy", 65, 100, 1000);
        OrderBookEntry order2 = new OrderBookEntry("ORDER-2", "USER-2", Side.yes, "buy", 65, 200, 2000);
        OrderBookEntry order3 = new OrderBookEntry("ORDER-3", "USER-3", Side.yes, "buy", 65, 150, 3000);
        ...
        OrderBookEntry sellOrder = new OrderBookEntry("SELL-1", "USER-4", Side.yes, "sell", 65, 250, 4000);
    ...
    public void testFIFOMixedYESNOOrders() {
        ...
        // Buy YES at 65¢
        OrderBookEntry yesBuy1 = new OrderBookEntry("YES-1", "USER-1", Side.yes, "buy", 65, 100, 1000);
        orderBook.addOrder(yesBuy1);
        
        // Sell NO at 35¢ (converts to Buy YES at 65¢)
        OrderBookEntry noSell1 = new OrderBookEntry("NO-1", "USER-2", Side.no, "sell", 35, 200, 2000);
        orderBook.addOrder(noSell1);
        
        // Buy YES at 65¢ again
        OrderBookEntry yesBuy2 = new OrderBookEntry("YES-2", "USER-3", Side.yes, "buy", 65, 150, 3000);
        orderBook.addOrder(yesBuy2);
        
        // Match a sell order
        OrderBookEntry sellOrder = new OrderBookEntry("SELL-1", "USER-4", Side.yes, "sell", 65, 350, 4000);
        List<Execution> executions = matchingEngine.matchOrder(sellOrder, orderBook);
    ...
    public void testMultiplePriceLevelsFIFO() {
        ...
        // Level 66¢
        orderBook.addOrder(new OrderBookEntry("BID-66-1", "U1", Side.yes, "buy", 66, 100, 1000));
        orderBook.addOrder(new OrderBookEntry("BID-66-2", "U2", Side.yes, "buy", 66, 100, 2000));
        
        // Level 65¢
        orderBook.addOrder(new OrderBookEntry("BID-65-1", "U3", Side.yes, "buy", 65, 100, 3000));
        orderBook.addOrder(new OrderBookEntry("BID-65-2", "U4", Side.yes, "buy", 65, 100, 4000));
        
        // Level 64¢
        orderBook.addOrder(new OrderBookEntry("BID-64-1", "U5", Side.yes, "buy", 64, 100, 5000));
        
        // Match a large sell order at 64¢
        OrderBookEntry sellOrder = new OrderBookEntry("SELL-1", "U6", Side.yes, "sell", 64, 400, 6000);
        List<Execution> executions = matchingEngine.matchOrder(sellOrder, orderBook);
    ...
    public void testOrderSequenceNumbers() throws InterruptedException {
        ...
        OrderBookEntry order1 = new OrderBookEntry("O1", "U1", Side.yes, "buy", 50, 100, System.currentTimeMillis());
        Thread.sleep(1); // Ensure different timestamps
        OrderBookEntry order2 = new OrderBookEntry("O2", "U2", Side.yes, "buy", 50, 100, System.currentTimeMillis());
        Thread.sleep(1);
        OrderBookEntry order3 = new OrderBookEntry("O3", "U3", Side.yes, "buy", 50, 100, System.currentTimeMillis());
    ...
    public void testPartialFillMaintainsFIFO() {
        ...
        OrderBookEntry order1 = new OrderBookEntry("O1", "U1", Side.yes, "buy", 70, 100, 1000);
        OrderBookEntry order2 = new OrderBookEntry("O2", "U2", Side.yes, "buy", 70, 100, 2000);
        
        orderBook.addOrder(order1);
        orderBook.addOrder(order2);
        
        // Partially fill first order
        OrderBookEntry sell1 = new OrderBookEntry("S1", "U3", Side.yes, "sell", 70, 60, 3000);
        ...
        OrderBookEntry sell2 = new OrderBookEntry("S2", "U4", Side.yes, "sell", 70, 50, 4000);
    ...
    public void testFIFOSameTimestamp() {
        ...
        OrderBookEntry order1 = new OrderBookEntry("O1", "U1", Side.yes, "buy", 55, 100, timestamp);
        OrderBookEntry order2 = new OrderBookEntry("O2", "U2", Side.yes, "buy", 55, 100, timestamp);
        OrderBookEntry order3 = new OrderBookEntry("O3", "U3", Side.yes, "buy", 55, 100, timestamp);
        ...
        // Match against them
        OrderBookEntry sellOrder = new OrderBookEntry("S1", "U4", Side.yes, "sell", 55, 250, timestamp + 1000);
        List<Execution> executions = matchingEngine.matchOrder(sellOrder, orderBook);
