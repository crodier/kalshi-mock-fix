...
public class PersistenceServicePositionTest {
    ...
    public void testCreateNewLongPosition() {
        ...
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, 100, 65);
        
        // Verify position was created
        Position position = persistenceService.getUserPosition(USER_ID, MARKET_TICKER, Side.yes);
    ...
    public void testCreateNewShortPosition() {
        ...
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, -50, 80);
    ...
    public void testIncreaseLongPosition() {
        // Initial buy: 100 @ 60¢
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, 100, 60);
        
        // Additional buy: 50 @ 70¢
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, 50, 70);
    ...
    public void testReduceLongPosition() {
        ...
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, -30, 75);
    ...
    public void testClosePosition() {
        ...
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, -100, 70);
    ...
    public void testFlipLongToShort() {
        ...
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.yes, -150, 70);
    ...
    public void testMultiplePositionsDifferentMarkets() {
        // Position 1: Long YES
        persistenceService.updatePosition(USER_ID, "MKT-1", "MARKET-1", Side.yes, 100, 65);
        
        // Position 2: Short YES different market
        persistenceService.updatePosition(USER_ID, "MKT-2", "MARKET-2", Side.yes, -50, 80);
        
        // Position 3: Long NO
        persistenceService.updatePosition(USER_ID, "MKT-3", "MARKET-3", Side.no, 200, 30);
        ...
        Position pos1 = persistenceService.getUserPosition(USER_ID, "MARKET-1", Side.yes);
        assertEquals(100, pos1.getQuantity());
        
        Position pos2 = persistenceService.getUserPosition(USER_ID, "MARKET-2", Side.yes);
        assertEquals(-50, pos2.getQuantity());
        
        Position pos3 = persistenceService.getUserPosition(USER_ID, "MARKET-3", Side.no);
    ...
    public void testSameMarketDifferentSides() {
        ...
        persistenceService.updatePosition(USER_ID, MARKET_ID, MARKET_TICKER, Side.no, 50, 35);
        
        // Verify both positions exist independently
        Position yesPosition = persistenceService.getUserPosition(USER_ID, MARKET_TICKER, Side.yes);
        assertEquals(100, yesPosition.getQuantity());
        assertEquals(65, yesPosition.getAvg_price());
        
        Position noPosition = persistenceService.getUserPosition(USER_ID, MARKET_TICKER, Side.no);
    ...
    public void testGetPositionsExcludesZeroQuantity() {
        ...
        persistenceService.updatePosition(USER_ID, "MKT-2", "MARKET-2", Side.yes, 50, 60);
